//===-- CPEN211AsmPrinter.cpp - CPEN21 LLVM assembly writer
//----------------===//
//
...
// of machine-dependent LLVM code to the CPEN211 assembly language.
//
//===----------------------------------------------------------------------===//

#include "CPEN211MCInstLower.h"
#include "CPEN211TargetMachine.h"
#include "MCTargetDesc/CPEN211InstPrinter.h"
...
// namespace {
// class CPEN211AsmPrinter : public AsmPrinter {
// public:
...
//     O << CPEN211InstPrinter::getRegisterName(MO.getReg());
//     return;
