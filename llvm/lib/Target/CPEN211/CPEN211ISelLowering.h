//===-- CPEN211ISelLowering.h - MSP430 DAG Lowering Interface ----*- C++
//-*-===//
//
...
//===----------------------------------------------------------------------===//
//
// This file defines the interfaces that CPEN211 uses to lower LLVM code into a
// selection DAG.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_CPEN211_MSP430ISELLOWERING_H
#define LLVM_LIB_TARGET_CPEN211_MSP430ISELLOWERING_H
...
enum NodeType : unsigned {
  ...
  /// CPEN211 conditional branches. Operand 0 is the chain operand, operand 1
...
class CPEN211Subtarget;
class CPEN211TargetLowering : public TargetLowering {
public:
  explicit CPEN211TargetLowering(const TargetMachine &TM,
